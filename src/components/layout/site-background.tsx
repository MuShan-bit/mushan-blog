...
export function SiteBackground() {
  return (
    <div aria-hidden="true" className="site-background">
      ...
      <div className="ambient-orb ambient-orb--mint top-[-5rem] left-[-10rem] h-[24rem] w-[24rem] animate-pulse" />
      <div className="ambient-orb ambient-orb--sky top-[12vh] right-[-8rem] h-[26rem] w-[26rem]" />
      <div className="ambient-orb ambient-orb--gold top-[48vh] left-[18%] h-[18rem] w-[18rem]" />
      <div className="ambient-orb ambient-orb--mint right-[12%] bottom-[-7rem] h-[22rem] w-[22rem]" />
    </div>
  );
}
