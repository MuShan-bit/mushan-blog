...
export function SiteFooter() {
  return (
    <footer className="relative z-10 px-5 pb-8 sm:px-8 lg:px-10">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 rounded-[2rem] border border-border bg-surface/70 px-6 py-6 backdrop-blur-2xl md:flex-row md:items-center md:justify-between">
        <div>
