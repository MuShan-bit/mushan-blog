...
ARG NEXT_PUBLIC_CN_SITE_URL=
ARG NEXT_PUBLIC_GLOBAL_SITE_URL=
ARG NEXT_PUBLIC_DEPLOY_REGION=
ARG NEXT_PUBLIC_OSS_BASE_URL=https://image-blog-mushan.oss-cn-beijing.aliyuncs.com
ARG NEXT_PUBLIC_SUPABASE_URL=
ENV NEXT_PUBLIC_SITE_URL=${NEXT_PUBLIC_SITE_URL}
ENV NEXT_PUBLIC_CN_SITE_URL=${NEXT_PUBLIC_CN_SITE_URL}
ENV NEXT_PUBLIC_GLOBAL_SITE_URL=${NEXT_PUBLIC_GLOBAL_SITE_URL}
ENV NEXT_PUBLIC_DEPLOY_REGION=${NEXT_PUBLIC_DEPLOY_REGION}
